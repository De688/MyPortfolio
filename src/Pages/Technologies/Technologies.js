      ...
      <div className='techwarapper'>
          ...
          <div className='alltechcontainer'>
            <div className='frontendtechs'>
               ...
               <div className='frontendlist'>
                          <div className='icon_and_name-container'>
                              <img src={reactjs} alt='reactjs-image' className='reacttechimage' />
                              <div className='iconstexts'>ReactJS</div>
                          </div>
                      <div className='icon_and_name-container'>
                        <img src={javascriptjs} alt='javascript-image' className='javascripttechimage' />
                        <div className='iconstexts'>Javascript</div>
                      </div>
                   <div className='icon_and_name-container'>
                        <img src={redux} alt='redux-image' className='reduxtechimage' />
            ...
            <div className='frontendtext'>
               ...
               <div className='frontendlist'>
               <div className='icon_and_name-container'>
                      <img src={nodejs} alt='nodetjs-image' className='nodetechimage' />
                      <div className='iconstexts'>NodeJS</div>
                   </div>
                   <div className='icon_and_name-container'>
                      <img src={expressjs} alt='express-image' className='expresstechimage' />
            ...
            <div className='frontendtext'>
               ...
               <div className='frontendlist'>
                    <div className='icon_and_name-container'>
                      <img src={mongodb} alt='mongodb-image' className='mongodbtechimage' />
                      <div className='iconstexts'>MongoDB</div>
                   </div>
               
                   <div className='icon_and_name-container'>
                        <img src={socketio} alt='socketio-image' className='socketiotechimage' />
                        <div className='iconstexts'>Socket.io</div>
                   </div>
                   <div className='icon_and_name-container'>
                      <img src={firebase} alt='firebase-image' className='firebasetechimage' />
